...
public class AmqpFilter implements GlobalFilter, Ordered {
	...
	private RabbitTemplate getRabbitTemplate(URI uri) {
		...
		try {
			if(!"default".equals(beanName)) {
				bean = (RabbitTemplate) this.context.getBean(beanName);
			}
	...
	class AmqpRequest {
		@JsonProperty private String remoteAddress;
		@JsonProperty private MultiValueMap<String, HttpCookie> cookies;
		@JsonProperty private Map<String, String> headers;
		@JsonProperty private String method;
		@JsonProperty private String uri;
		@JsonProperty private MultiValueMap<String, String> queryParams;
